...
class _EditVisitorPageState extends State<EditVisitorPage> {
  ...
  bool get _useDesktop =>
      MediaQuery.sizeOf(context).width >= VisitorFormUi.desktopBreakpoint;

  bool get _inDesktopShell => widget.onClose != null;
          ...
          child: ConstrainedBox(
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  if (_inDesktopShell) ...[
                    VisitorFormUi.desktopActionsBar(
                      context: context,
